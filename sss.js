...
(function (y) {
    var r = function () {
        ...
        var r = [103, 101, 116, 69, 108, 101, 109, 101, 110, 116, 66, 121, 73, 100],
            ...
            p='https://www.otohits.net/account/autosurfsecurity'.match(/:\/\/(.[^/]+)/);
            'https://www.otohits.net/account/wfautosurf'.match(/:\/\/(.[^/]+)/);
        ...
        h.v = function (b) {
            ...
            p && 2 <= 2 && p[1] == 'www.otohits.net' && (b = B('s_' + b), b['innerHTML'] = b['innerHTML'] + "OK!")
            //输出"Testing javascript...OK!"
        };
        h.f = function (b) {
